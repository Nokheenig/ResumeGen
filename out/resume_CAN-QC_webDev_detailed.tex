...
\hypersetup{
  ...
  pdfkeywords={profile:webDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2025-05-25 19:43:29.035116 ; id:f19a81},
  pdfcreator={LuaLaTeX},
...
\makebox[4.3cm][l]{\textbf{Coréen} (A1-2)}\vspace{2.5mm}
...
\emph{Auto-généré en \LaTeX}
\emph{Date: 25/05/2025} \hspace*{8mm}
\emph{Id: f19a81} % resumeId
%{\tiny f19a81} % resumeId
