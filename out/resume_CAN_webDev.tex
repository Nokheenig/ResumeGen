...
\hypersetup{
  ...
  pdfkeywords={profile:webDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2025-05-25 19:43:29.006076 ; id:02e28f},
  pdfcreator={LuaLaTeX},
...
\makebox[4.3cm][l]{\textbf{Korean} (A1-2)}\vspace{2.5mm}
...
\emph{Auto-generated in \LaTeX}
\emph{Date: 05/25/2025} \hspace*{8mm}
\emph{Id: 02e28f} % resumeId
%{\tiny 02e28f} % resumeId
