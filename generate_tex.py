...
\vspace{{0.5mm}}"""
    ...
    def getResumeDataStackByFileByProfile(self) -> dict[Path,dict[str,list[dict]]]:
        ...
        # for file, fileData in self.rawDataDictionariesByFile.items():
        #     fileProfiles = self.sessionProfileListByResume[file]
        #     # filteredProfiles = [profile for profile in fileProfiles if profile in self.sessionProfileListByResume]
        #     for profile in fileProfiles:
