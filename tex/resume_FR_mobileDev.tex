...
\hypersetup{
  ...
  pdfsubject={Développeur Web \& Mobile Full Stack - Curriculum Vitae},
  pdfkeywords={profile:mobileDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2026-02-02 14:06:39.712311 ; id:8e36f7},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_FR_mobileDev.png}\\
\vspace{2.5mm}
...
\noindent\parbox{\linewidth}{
  \centering
  Ingénieur et Concepteur Développeur d'Application guidé par un sens du détail et de la performance, à la recherche de nouveaux défis!
}
\vspace*{0.8mm}
