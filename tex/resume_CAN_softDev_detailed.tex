...
\hypersetup{
  ...
  pdfkeywords={profile:softDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2026-02-18 00:04:32.235800 ; id:19d0ea},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_CAN_softDev_detailed.png}\\
\vspace{2.5mm}
...
\small \emph{Date: 02/18/2026} \hspace*{8mm}\\
\small \emph{Id: 19d0ea} % resumeId\\
%{\tiny 19d0ea}\\ % resumeId
