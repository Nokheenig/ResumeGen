...
\hypersetup{
  ...
  pdfkeywords={profile:softDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2026-02-18 00:04:32.234826 ; id:fc4660},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_CAN-QC_softDev_detailed.png}\\
\vspace{2.5mm}
