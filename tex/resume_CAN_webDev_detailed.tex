...
\hypersetup{
  ...
  pdfkeywords={profile:webDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2025-06-07 10:56:45.753306 ; id:e2a6bb},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_CAN_webDev_detailed.png}\\
\vspace{2.5mm}
