...
\hypersetup{
  ...
  pdfsubject={Développeur Web \& Mobile Full Stack - Resume},
  pdfkeywords={profile:mobileDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2026-02-02 14:06:39.705381 ; id:3d7fb7},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_CAN-QC_mobileDev.png}\\
\vspace{2.5mm}
