...
\hypersetup{
  ...
  pdfkeywords={profile:mobileDev; resume; developer; software; engineer; C\# .Net; Python; Javascript; Node.js; Java; Kotlin; Android; Rest API; Git  GitLab; Docker; Jenkins; Selenium; Cron; Html-Css; MySQL; PostgreSQL; MongoDB; SQLite; Firebase; Bash; Jira; Regex; createdAt:2026-02-02 14:06:39.708782 ; id:51dc76},
  pdfcreator={LuaLaTeX},
...
\vspace{2.5mm}
\includegraphics[width=1.5cm,height=3cm,keepaspectratio]{qr/resume_CAN_mobileDev.png}\\
\vspace{2.5mm}
...
\small \emph{Date: 02/02/2026} \hspace*{8mm}\\
\small \emph{Id: 51dc76} % resumeId\\
%{\tiny 51dc76}\\ % resumeId
